...
.vlarge[We turn to compuational, **machine learning** techniques to gate populations for us.]
...
<center>
<div>
<img src="img/Curse_of_dimensionality.png">
</div>
</center>
...
.vlarge[**Unsupervised** machine learning!]
...
- .large[**Principal components analysis**]
  - Linear dimension reduction
  - Principal components are linear combinations of existing variables
...
- .large[**t-distributed stochastic neighbor embedding / t-SNE**]
  - Non-linear dimension reduction
  - Calculates distance between cases, then tries to reproduce these distances in fewer dimensions
  - Computationally expensive
  - Works well for flow cytometry data

--

- .large[**Uniform manifold approximation and projection / UMAP**]
  - Non-linear dimension reduction
  - Works in a similar way to t-SNE, but calculates distances differently
